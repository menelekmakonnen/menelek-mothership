...
// In production, this would be loaded from Google Drive API or other sources
    ...
    items: [
      {
        ...
        coverUrl: 'https://images.unsplash.com/photo-1478720568477-152d9b164e26?w=400&h=700&fit=crop',
        type: 'video',
      ...
      },
      {
        id: 'film-2',
        title: 'Music Video',
        coverUrl: 'https://images.unsplash.com/photo-1514320291840-2e0a9bf2a9ae?w=400&h=700&fit=crop',
        type: 'video',
        url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
        duration: '4:12',
        year: 2024,
    ...
    categories: [
      {
        id: 'action',
        name: 'Action Edits',
        coverUrl: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=400&h=700&fit=crop',
        itemCount: 5,
        items: [
          {
            id: 'action-1',
            title: 'Epic Montage',
            url: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&h=1200&fit=crop',
