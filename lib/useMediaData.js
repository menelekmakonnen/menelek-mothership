...
export const useMediaData = () => {
  ...
  useEffect(() => {
    const loadMediaData = async () => {
      ...
      console.log('\n========================================');
      console.log('📦 LOADING MEDIA FROM GOOGLE SHEETS (GViz)');
      console.log('========================================\n');
      ...
      // Fetch all data from Google Sheets (GViz - no API key needed!)
      console.log('🔍 Using GViz public endpoint (no API key required)\n');
